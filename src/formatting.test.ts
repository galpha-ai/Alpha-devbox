...
describe('trigger gating (requiresTrigger interaction)', () => {
  // Replicates the logic from requiresTrigger() in index.ts for channel-scope
  // (non-thread) sessions. The agent name no longer affects trigger behavior;
  // only the requires_trigger config value matters.
  ...
  it('requiresTrigger=undefined requires trigger (defaults to true)', () => {
